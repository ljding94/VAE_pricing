...
def plot_latent_space():
    ...
    ax1.set_ylabel(r"$P(\mu)$", fontsize=9, labelpad=-2)
    ...
    cbar1.ax.set_yticks([0, 2, 4, 6])
    cbar1.ax.set_yticklabels([f"${i}$" for i in [0, 2, 4, 6]])
    ...
    ax2.set_ylabel(r"$P(2\log s)$", fontsize=9, labelpad=-2)
...
def plot_price_prediction():
    ...
    ax1.set_xlabel("Grount Truth", fontsize=9, labelpad=0)
    ...
    ax2.set_xlabel("Grount Truth", fontsize=9, labelpad=0)
    ...
    plt.tight_layout(pad=0.1)
    plt.savefig("./figures/price_prediction.png", dpi=300)
    plt.savefig("./figures/price_prediction.pdf", dpi=500, format="pdf")
